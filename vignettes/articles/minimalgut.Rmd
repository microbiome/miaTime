...
```{r getStepwiseDivergence, fig.height=4, fig.width=8}
# Load libraries
library(miaTime)
library(dplyr)
...
p <- ggplot(as.data.frame(colData(tse)),
         aes(x=time_from_baseline,
...
```{r rollmean, fig.height=4, fig.width=8}
...
```{r errorbars, fig.height=4, fig.width=8}
