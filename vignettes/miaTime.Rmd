...
`miaTime` implements tools for time series manipulation based on the `TreeSummarizedExperiment` data container. Much of the functionality is also applicable to the `SummarizedExperiment` data objects as well.
